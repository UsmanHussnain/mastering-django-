    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('paypal', 'Paypal'), ('payoneer', 'Payoneer'), ('check', 'Check Payment'), ('bank', 'Direct Bank Transfer'), ('cod', 'Cash on Delivery')], max_length=20)),
